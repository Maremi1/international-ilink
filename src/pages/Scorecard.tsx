...
const pillar2 = [
  {
    cat: "Network",
    score: "10 pts",
    text: "Pre-existing SME or vendor database featuring 500+ contacts.",
  },
  {
    cat: "Infrastructure",
    score: "10 pts",
    text: "Verified access to physical nodes for regional Pick-up Centers.",
  },
  {
    cat: "Market Experience",
    score: "5 pts",
    text: "Minimum of 5+ years navigating National Retail or Logistics.",
  },
];
...
const pillar3 = [
  {
    cat: "IT Talent",
    score: "10 pts",
    text: "In-house CTO or team capable of Mobile Money / Bank API integration.",
  },
  {
    cat: "Regulatory Standing",
    score: "10 pts",
    text: "Valid Payment Service Provider (PSP) license or impeccable Tax Record.",
  },
  {
    cat: "Data Security",
    score: "5 pts",
    text: "Demonstrated fluency with national Data Protection Acts.",
  },
];
...
const pillar4 = [
  {
    cat: "Mission Fit",
    score: "5 pts",
    text: "Ideological alignment with Mama Mia's Foundation objectives.",
  },
  {
    cat: "Brand Integrity",
    score: "5 pts",
    text: "Strict commitment to curating high-quality, localized content.",
  },
  {
    cat: "Growth Vision",
    score: "5 pts",
    text: "Realistic feasibility of the applicant's 5-Year Scaling Plan.",
  },
];
...
const decisions = [
  {
    range: "< 60",
    title: "Decline",
    text: "Fails to meet minimum infrastructure requirements for the Soko ecosystem.",
  },
  {
    range: "60 – 74",
    title: "Conditional",
    text: "Promising, but requires a local co-partner or increased security deposit.",
  },
  {
    range: "75 – 89",
    title: "Qualified",
    text: "Clears the threshold. Proceed to formal interview and due diligence.",
  },
  {
    range: "90 – 100",
    title: "Platinum",
    text: "Elite candidate. Proceed to immediate Master Franchise Agreement.",
  },
];
...
const docs = [
  {
    ...
    text: "Historic performance in retail, logistics, or fintech.",
  },
  {
    title: "Proof of Capital",
    text: "Formal bank reference letters covering the Fee and OpEx reserves.",
  },
  {
    title: "Market Entry Plan",
    text: "A summarized strategic roadmap for achieving Year 1 targets.",
  },
  {
    title: "Tax Clearance & Incorporation",
    text: "Validated legal standing in the requested sovereign territory.",
  },
];
...
const ScorecardPage = () => {
  return (
    <main className="relative min-h-screen overflow-x-hidden">
      <SEO
        title="11-Point Scorecard Verification | i Link International"
        description="Become an operator for i Link's 11-Point Scorecard Verification process. Verify suppliers, buyers, and businesses for global standards compliance."
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <h1 className="font-display text-4xl md:text-6xl font-bold mb-6 leading-tight">
                ...
                <span className="text-gradient">Requirements Guide</span>
              </h1>
              <p className="text-lg text-muted-foreground leading-relaxed mb-4">
                Securing an Exclusive Country Franchise requires clearing a
                strict 75% evaluation threshold. Applicants are scored across
                four weighted capability pillars, with a minimum aggregate of
                75/100 required to pass the initial audit phase.
              </p>
              <p className="text-sm text-muted-foreground">
                Proprietary &amp; Confidential · i Link Limited
              </p>
            </motion.div>
        ...
        <div className="container mx-auto px-4">
          <div className="glass-card p-10 md:p-14 text-center max-w-3xl mx-auto">
            ...
            <p className="text-lg text-muted-foreground">
              The minimum aggregate score required to pass the initial audit and
              secure a
              <span className="font-semibold text-foreground"> "Go" </span>{" "}
              decision from the i Link Executive Board.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 md:py-16">
        <div className="container mx-auto px-4">
          <h2 className="font-display text-3xl md:text-5xl font-bold mb-12 text-center">
            Four Weighted{" "}
            <span className="text-gradient">Capability Pillars</span>
          </h2>
        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-10 items-center max-w-6xl mx-auto">
            <div className="order-last lg:order-first">
              ...
              <h2 className="font-display text-3xl md:text-4xl font-bold mb-6">
                Technical &amp;{" "}
                <span className="text-gradient">Regulatory</span>
              </h2>
              <div className="space-y-4">
                {pillar3.map((c) => (
                  <div
      ...
      <section className="py-12 md:py-16">
        <div className="container mx-auto px-4">
          <h2 className="font-display text-3xl md:text-4xl font-bold mb-3 text-center">
            Four Definitive{" "}
            <span className="text-gradient">Executive Decisions</span>
          </h2>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground mb-8">
              Users can freely download our comprehensive Selection Scorecard
              document for full details on the evaluation thresholds, capability
              pillars, and executive decision frameworks.
            </p>
            <a
              href="/Soko_Franchise_Selection_Scorecard.pdf"
              download
