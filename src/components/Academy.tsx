      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <h2 className="font-display text-4xl md:text-6xl font-bold mb-6 leading-tight">
            i Link Academy: Accelerating <span className="text-gradient">Human Capital</span>
          </h2>
          ...
          {programs.map((p, i) => (
            ...
            >
              <div className="relative h-72 overflow-hidden">
                ...
                <h3 className="absolute bottom-3 left-5 font-display text-2xl font-bold drop-shadow text-white">{p.title}</h3>
              </div>
              <div className="relative p-5">
                <div className="text-xs uppercase tracking-wider text-primary mb-2">Program {p.n}</div>
